...
public class FilmesDBHelper extends SQLiteOpenHelper
{
    ...
    private static final String DATABASE_NAME = "bollymovies.db";
    ...
    @Override
    public void onCreate(SQLiteDatabase db) { // executado toda vez que o banco de dados for criado
        String sqlTableFilmes = "CREATE TABLE " + FilmesContract.FilmeEntry.TABLE_NAME + " ( " +
                ...
                FilmesContract.FilmeEntry.COLUMN_AVALIACAO + " REAL NOT NULL" +
                ");";
